...
function enhanceAiNavigation() {
  ...
  const iconMarkup = {
    openai: `
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.58" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">
        <path d="M12.02 2.9a4.5 4.5 0 0 1 4.2 6.08l-4.18-2.41a2.56 2.56 0 0 0-2.56 0L7.7 7.6a4.5 4.5 0 0 1 4.32-4.7Z"></path>
        <path d="M19.73 7.35a4.5 4.5 0 0 1-2.28 6.7V9.23a2.56 2.56 0 0 0-1.28-2.22l-1.8-1.04a4.5 4.5 0 0 1 5.36 1.38Z"></path>
        <path d="M19.72 16.27a4.5 4.5 0 0 1-6.48 1.75l4.17-2.41a2.56 2.56 0 0 0 1.28-2.22v-2.08a4.5 4.5 0 0 1 1.03 4.96Z"></path>
        <path d="M11.98 21.1a4.5 4.5 0 0 1-4.2-6.08l4.18 2.41a2.56 2.56 0 0 0 2.56 0l1.78-1.03a4.5 4.5 0 0 1-4.32 4.7Z"></path>
        <path d="M4.27 16.65a4.5 4.5 0 0 1 2.28-6.7v4.82a2.56 2.56 0 0 0 1.28 2.22l1.8 1.04a4.5 4.5 0 0 1-5.36-1.38Z"></path>
        <path d="M4.28 7.73a4.5 4.5 0 0 1 6.48-1.75L6.59 8.39a2.56 2.56 0 0 0-1.28 2.22v2.08a4.5 4.5 0 0 1-1.03-4.96Z"></path>
        <path d="m9.47 6.58 5.06 2.92v5l-5.06 2.92"></path>
        <path d="M17.45 9.25 12.39 12l-4.84-2.75"></path>
        <path d="M6.55 14.75 11.61 12l4.84 2.75"></path>
      </svg>
    `,
    claude: `
